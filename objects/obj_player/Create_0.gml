...
//teste com posicao temporaria de x e y local antes de enviar ao server
xl = x
yl = y

//envio de informacos basicas p o server
scr_enviar("x", xl, msg_type.CREATE_HOST)			//enviar x para o server
scr_enviar("y", yl, msg_type.SET_PLAYER_STAT)		//enviar y para o server
scr_enviar("id", id, msg_type.SET_PLAYER_STAT)		//enviar id para o server
